...
5. Search combines every valid existing release ID with album-artist/album text search.
...
21. An existing-ID anchored candidate receives no score or ordering bonus.
